...
Public Class cryInadiplentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryInadiplentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryInadiplentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryInadiplentes = New cryInadiplentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
