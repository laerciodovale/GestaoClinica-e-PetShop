...
Public Class cryAutEutanasia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryAutEutanasia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryAutEutanasia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryAutEutanasia = New cryAutEutanasia()
        rpt.Site = Me.Site
        Return rpt
    End Function
