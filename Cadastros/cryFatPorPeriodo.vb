...
Public Class cryFatPorPeriodo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryFatPorPeriodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryFatPorPeriodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryFatPorPeriodo = New cryFatPorPeriodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
