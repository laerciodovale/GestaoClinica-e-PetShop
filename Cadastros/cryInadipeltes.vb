...
Public Class cryInadipeltes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryInadipeltes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryInadipeltes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryInadipeltes = New cryInadipeltes()
        rpt.Site = Me.Site
        Return rpt
    End Function
