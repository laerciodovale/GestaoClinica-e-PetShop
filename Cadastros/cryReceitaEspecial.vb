...
Public Class cryReceitaEspecial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryReceitaEspecial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nroReceita() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryReceitaEspecial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryReceitaEspecial = New cryReceitaEspecial()
        rpt.Site = Me.Site
        Return rpt
    End Function
