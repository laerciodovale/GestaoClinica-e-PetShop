...
Public Class cryFatFuncGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryFatFuncGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryFatFuncGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryFatFuncGrupo = New cryFatFuncGrupo()
        rpt.Site = Me.Site
        Return rpt
    End Function
