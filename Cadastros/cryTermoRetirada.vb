...
Public Class cryTermoRetirada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryTermoRetirada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryTermoRetirada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryTermoRetirada = New cryTermoRetirada()
        rpt.Site = Me.Site
        Return rpt
    End Function
