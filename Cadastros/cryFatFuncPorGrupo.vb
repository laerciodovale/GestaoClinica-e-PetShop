...
Public Class cryFatFuncPorGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryFatFuncPorGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryFatFuncPorGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryFatFuncPorGrupo = New cryFatFuncPorGrupo()
        rpt.Site = Me.Site
        Return rpt
    End Function
