...
Public Class cryInadimplentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryInadimplentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CodCli() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryInadimplentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryInadimplentes = New cryInadimplentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
