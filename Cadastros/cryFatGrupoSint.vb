...
Public Class cryFatGrupoSint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryFatGrupoSint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryFatGrupoSint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryFatGrupoSint = New cryFatGrupoSint()
        rpt.Site = Me.Site
        Return rpt
    End Function
