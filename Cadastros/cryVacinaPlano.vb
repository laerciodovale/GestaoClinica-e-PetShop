...
Public Class cryVacinaPlano
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cadastros.cryVacinaPlano.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdPaciente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryVacinaPlano
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryVacinaPlano = New cryVacinaPlano()
        rpt.Site = Me.Site
        Return rpt
    End Function
